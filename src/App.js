...
function App() {
  ...
  if (page === 'Test') {
    content = <div style={{fontSize:40,display:'flex',justifyContent:'center',paddingTop:100,textAlign:'center'}}>
    Sorry
    <br />
    Comming soon
  </div>
    option = (
      <Option page={page} addList={addList} updateAddList={updateAddList} />
    );
  }
